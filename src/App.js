  ...
  getBetDataById = async (BetId) => {
    ...
    render() {
      ...
      <div className={'my-extension text-center'}>
       ...
       <div className="nav-wrapper" style={{paddingLeft:10,paddingRight:10}}>
